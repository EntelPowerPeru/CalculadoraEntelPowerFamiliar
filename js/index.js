...
const HELPERS = {
  ...
  t36(total_planes_actuales, q_lineas) {
  ...
  v36(total_lineas, total_planes_actuales, q_lineas) {
    const t36 = this.t36(total_planes_actuales, q_lineas);

    const monto = LISTA_MENSUAL_CON_FAMILIA.find(e => e.plan === t36 && e.lineas === total_lineas)?.monto;
